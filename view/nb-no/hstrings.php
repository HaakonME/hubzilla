...
$a->strings["Enables a tool to store notes and reminders (note: not encrypted)"] = "Skru på et verktøy for å lagre notater og påminnelser (merknad: ikke kryptert)";
...
$a->strings["Enable management and selection of privacy groups"] = "Skru på håndtering og valg av personverngrupper";
...
$a->strings["Rating Tools"] = "Vurderingsverktøy";
...
$a->strings["Feed - Mostly Public"] = "Strøm - ganske offentlig";
$a->strings["Feed - Restricted"] = "Strøm - begrenset";
...
$a->strings["Pending approval"] = "Venter på godkjenning";
...
$a->strings["Connections search"] = "Søk blant forbindelser";
...
$a->strings["Connection requests will be approved without your interaction"] = "Forespørsler om forbindelse vil bli godkjent automatisk";
...
$a->strings["Edit event title"] = "Endre tittel på hendelse";
$a->strings["Event title"] = "Tittel på hendelse";
...
$a->strings["Unable to remove privacy group."] = "Ikke i stand til å fjerne personverngruppen.";
...
$a->strings["or visit"] = "eller besøke";
...
$a->strings["Your nickname will be used to create an easy to remember channel address e.g. nickname%s"] = "Ditt kallenavn brukes til å lage en kanaladresse som er enkel å huske, for eksempel kallenavn%s";
...
$a->strings["Expiration period in days for imported (grid/network) content"] = "Antall dager før importert innhold (nettet/nettverk) utgår";
$a->strings["0 for no expiration of imported content"] = "0 dersom importert innhold ikke skal utgå";
$a->strings["Off"] = "Av";
$a->strings["On"] = "På";
$a->strings["Lock feature %s"] = "Lås funksjon %s";
$a->strings["Manage Additional Features"] = "Håndter tilleggsfunksjoner";
...
$a->strings["Check to block public access to all otherwise public personal pages on this site unless you are currently authenticated."] = "Kryss av for å blokkere tilgang til alle personlige sider som ellers ville vært offentlig tilgjengelige på dette nettstedet med mindre du er logget inn.";
$a->strings["Allow communications only from these sites"] = "Tillat kommunikasjon med bare disse nettstedene";
$a->strings["One site per line. Leave empty to allow communication from anywhere by default"] = "Et nettsted per linje. La det stå tomt for å tillate kommunikasjon med ethvert nettsted som standard";
...
$a->strings["One channel (hash) per line. Leave empty to allow from any channel by default"] = "En kanal (hash) per linje. La det stå tomt for å tillate enhver kanal som standard";
...
$a->strings["One site per line. Leave empty to allow from any site by default"] = "Et nettsted per linje. La stå tomt for å tillate ethvert nettsted som standard";
...
$a->strings["Enable to share embed security with other compatible sites/hubs"] = "Skru på deling av innebyggingssikkerhet med andre kompatible nettsteder/hubber";
...
$a->strings["Poke, prod or do other things to somebody"] = "Dult, prikk eller gjør andre ting med noen";
...
$a->strings["Registration on this hub is by approval only."] = "Registrering ved dette nettstedet skjer på godkjenning.";
...
$a->strings["Proceed to create your first channel"] = "Gå videre for å lage din første kanal";
...
$a->strings["Feature/Addon Settings"] = "Funksjons-/Tilleggsinnstillinger";
$a->strings["Account Settings"] = "Kontoinnstillinger";
$a->strings["Current Password"] = "Nåværende passord";
...
$a->strings["Preload images before rendering the page"] = "Last inn bildene før gjengivelsen av siden";
$a->strings["The subjective page load time will be longer but the page will be ready when displayed"] = "Den personlige opplevelsen av lastetiden vil være lenger, men siden vil være klar når den vises";
...
$a->strings["Use blog/list mode on grid page"] = "Bruk blogg-/liste-modus på nettverkssiden";
...
$a->strings["Grid page max height of content (in pixels)"] = "Nettverkssidens makshøyde for innhold (i piksler)";
...
$a->strings["0 or blank to use the website limit. The website expires after %d days."] = "0 eller ikke noe for å bruke nettstedets grense. Nettstedet utløper etter %d dager.";
...
$a->strings["Enable \$Projectname <strong>advanced</strong> features?"] = "Skru på <strong>avanserte</strong egenskaper i \$Projectname ?";
