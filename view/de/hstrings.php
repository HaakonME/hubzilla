...
App::$strings["Confirmation completed successfully."] = "";
...
App::$strings["Drop files here to upload"] = "";
App::$strings["Failed"] = "Fehlgeschlagen";
App::$strings["No files were uploaded."] = "";
...
App::$strings["File has an invalid extension, it should be one of "] = "";
App::$strings["Upload was cancelled, or server error encountered"] = "";
...
App::$strings["Email notification hub"] = "";
App::$strings["Hostname"] = "";
App::$strings["Mailhost Settings"] = "";
App::$strings["MAILHOST Settings saved."] = "";
...
App::$strings["A proximity alert will be issued when this member is within a certain radius of you.<br><br>Enter a radius in meters:"] = "Ein Annäherungsalarm wird ausgelöst, sobald sich dieses Mitglied innerhalb eines bestimmten Radius zu Dir befindet.<br><br>Gib den Radius in Metern ein:";
App::$strings["distance"] = "Entfernung";
App::$strings["Add new rendezvous"] = "Neues Rendezvous hinzufügen";
App::$strings["Create a new rendezvous and share the access link with those you wish \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tto invite to the group. Those who open the link become members of the \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\trendezvous. They can view other member locations, add markers to the map,\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tor share their own locations with the group."] = "";
