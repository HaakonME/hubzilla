...
function sync_directories($dirmode) {
	...
	if ((! $r) && (z_root() != DIRECTORY_FALLBACK_MASTER)) {
		...
		$r[] = array(
			...
			'site_valid' => 1,
			'site_project' => PLATFORM_NAME
			
		);
		$x = q("insert into site ( site_url, site_flags, site_update, site_directory, site_realm, site_valid, site_project )
