...
$a->strings["$Projectname Notification"] = "RedMatrix-notificatie";
$a->strings["$projectname"] = "RedMatrix";
...
$a->strings["Matrix Activity"] = "RedMatrix-activiteit";
...
$a->strings["projectname"] = "RedMatrix";
$a->strings["Some blurb about what to do when you're new here"] = "Welkom op RedMatrix. Klik op de tab ontdekken of klik rechtsboven op de <a href=\"directory\">kanalengids</a>, om kanalen te vinden. Rechtsboven vind je ook onze <a href=\"directory\">apps</a>, waar je vrijwel alles van RedMatrix kan vinden. Voor <a href=\"directory\">hulp</a> met RedMatrix klik je op het vraagteken of als je meer vragen hebt stel je die in het <a href=\"https://zothost.me/channel/support\">supportkanaal</a> (liefst in het Engels).";
...
$a->strings["Prevents displaying in your profile that you are online"] = "Voorkomt dat op je kanaal te zien valt dat je momenteel op RedMatrix aanwezig bent";
...
$a->strings["Please <a href=\"rmagic\">login with your $Projectname ID</a> or <a href=\"register\">register as a new $Projectname member</a> to continue."] = "Je dient <a href=\"rmagic\">in te loggen met je RedMatrix-account</a> of <a href=\"register\">een nieuw RedMatrix-account te registreren</a> om verder te kunnen gaan.";
...
$a->strings["$Projectname channel"] = "RedMatrix-kanaal";
...
$a->strings["This is a hub of $Projectname - a global cooperative network of decentralized privacy enhanced websites."] = "Dit is een RedMatrix-hub - RedMatrix is een wereldwijd coöperatief netwerk van gedecentraliseerde websites (hubs) met verbeterde privacy.";
$a->strings["Tag: "] = "Tag: ";
$a->strings["Last background fetch: "] = "Meest recente achtergrond-fetch:";
$a->strings["Running at web location"] = "Draaiend op weblocatie";
$a->strings["Please visit <a href=\"https://redmatrix.me\">redmatrix.me</a> to learn more about $Projectname."] = "Bezoek <a href=\"https://redmatrix.me\">RedMatrix.me</a> om meer over RedMatrix te leren.";
...
$a->strings["Help:"] = "Hulp:";
$a->strings["Not Found"] = "Niet gevonden";
$a->strings["$Projectname Server - Setup"] = "RedMatrix Server - Setup";
...
$a->strings["In order to install $Projectname we need to know how to connect to your database."] = "In order to install RedMatrix we need to know how to connect to your database.";
...
$a->strings["$Projectname - Guests: Username: {your email address}, Password: +++"] = "RedMatrix - gasttoegang: Accountnaam: {jouw e-mailadres}, wachtwoord: +++";
...
$a->strings["Please join us on Red"] = "Uitnodiging voor RedMatrix";
...
$a->strings["Please join my community on $Projectname."] = "Hierbij nodig ik je uit om mij, en andere vrienden en kennissen, op RedMatrix te vergezellen. Lees meer over RedMatrix op https://redmatrix.me.";
$a->strings["You will need to supply this invitation code: "] = "Je moet deze uitnodigingscode opgeven:";
$a->strings["1. Register at any $Projectname location (they are all inter-connected)"] = "1. Registreer je op een willekeurige RedMatrix-hub (ze zijn allemaal onderling met elkaar verbonden):";
$a->strings["2. Enter my $Projectname network address into the site searchbar."] = "2. Nadat je bent ingelogd en een kanaal hebt aangemaakt kan je mijn RedMatrix-kanaaladres in het zoekveld invullen:";
...
$a->strings["Create an account to access services and applications within the Red Matrix"] = "Maak een account aan om toegang te krijgen tot diensten en toepassingen van RedMatrix";
