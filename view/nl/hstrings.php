...
App::$strings["Choose an available wiki from the list on the left."] = "Kies een beschikbare wiki uit de linkerlijst.";
...
App::$strings["Create new wiki"] = "Nieuwe wiki aanmaken";
App::$strings["Send notification"] = "Verzend een notificatie";
